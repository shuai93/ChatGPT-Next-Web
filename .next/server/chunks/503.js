...
;// CONCATENATED MODULE: ./app/icons/edit.svg
var edit_defs, edit_mask;
...
var SvgEdit = function SvgEdit(props) {
  return /*#__PURE__*/react_.createElement("svg", edit_extends({
    xmlns: "http://www.w3.org/2000/svg",
    xmlnsXlink: "http://www.w3.org/1999/xlink",
    width: 16,
    height: 16,
    fill: "none"
  }, props), edit_defs || (edit_defs = /*#__PURE__*/react_.createElement("defs", null, /*#__PURE__*/react_.createElement("path", {
    id: "edit_svg__a",
    d: "M0 0h16v16H0z"
  }))), /*#__PURE__*/react_.createElement("g", null, edit_mask || (edit_mask = /*#__PURE__*/react_.createElement("mask", {
    id: "edit_svg__b",
    fill: "#fff"
  }, /*#__PURE__*/react_.createElement("use", {
...
var SvgEye = function SvgEye(props) {
  return /*#__PURE__*/react_.createElement("svg", eye_extends({
    width: 800,
    height: 800,
    viewBox: "0 0 24 24",
    fill: "none",
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* List */.aV, {
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                title: locales/* default.Settings.Update.Version */.ZP.Settings.Update.Version(currentId),
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* List */.aV, {
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                ...
                                children: /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                    icon: /*#__PURE__*/ jsx_runtime_.jsx(edit, {}),
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* List */.aV, {
                        children: [
                            enabledAccessControl ? /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                title: locales/* default.Settings.HistoryCount.Title */.ZP.Settings.HistoryCount.Title,
                                subTitle: locales/* default.Settings.HistoryCount.SubTitle */.ZP.Settings.HistoryCount.SubTitle,
                                children: /*#__PURE__*/ jsx_runtime_.jsx(InputRange, {
                                    ...
                                    max: "25",
                                    step: "1",
                                    onChange: (e)=>updateConfig((config)=>config.historyMessageCount = e.target.valueAsNumber)
                                })
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                title: locales/* default.Settings.CompressThreshold.Title */.ZP.Settings.CompressThreshold.Title,
                                subTitle: locales/* default.Settings.CompressThreshold.SubTitle */.ZP.Settings.CompressThreshold.SubTitle,
                                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                    type: "number",
                                    min: 500,
                                    max: 4000,
                                    value: config.compressMessageLengthThreshold,
                                    onChange: (e)=>updateConfig((config)=>config.compressMessageLengthThreshold = e.currentTarget.valueAsNumber)
                                })
                            })
                        ]
                    }),
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* List */.aV, {
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                title: locales/* default.Settings.Model */.ZP.Settings.Model,
                                children: /*#__PURE__*/ jsx_runtime_.jsx("select", {
                                    value: config.modelConfig.model,
                                    onChange: (e)=>{
                                        updateConfig((config)=>config.modelConfig.model = store/* ModalConfigValidator.model */.Xm.model(e.currentTarget.value));
                                    },
                                    children: store/* ALL_MODELS.map */.L.map((v)=>/*#__PURE__*/ jsx_runtime_.jsx("option", {
                                            value: v.name,
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                title: locales/* default.Settings.Temperature.Title */.ZP.Settings.Temperature.Title,
                                subTitle: locales/* default.Settings.Temperature.SubTitle */.ZP.Settings.Temperature.SubTitle,
                                children: /*#__PURE__*/ jsx_runtime_.jsx(InputRange, {
                                    ...
                                    step: "0.1",
                                    onChange: (e)=>{
                                        updateConfig((config)=>config.modelConfig.temperature = store/* ModalConfigValidator.temperature */.Xm.temperature(e.currentTarget.valueAsNumber));
                                    }
                                })
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                title: locales/* default.Settings.MaxTokens.Title */.ZP.Settings.MaxTokens.Title,
                                subTitle: locales/* default.Settings.MaxTokens.SubTitle */.ZP.Settings.MaxTokens.SubTitle,
                                children: /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                    type: "number",
                                    min: 100,
                                    max: 32000,
                                    value: config.modelConfig.max_tokens,
                                    onChange: (e)=>updateConfig((config)=>config.modelConfig.max_tokens = store/* ModalConfigValidator.max_tokens */.Xm.max_tokens(e.currentTarget.valueAsNumber))
                                })
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx(SettingItem, {
                                title: locales/* default.Settings.PresencePenlty.Title */.ZP.Settings.PresencePenlty.Title,
                                subTitle: locales/* default.Settings.PresencePenlty.SubTitle */.ZP.Settings.PresencePenlty.SubTitle,
                                children: /*#__PURE__*/ jsx_runtime_.jsx(InputRange, {
                                    ...
                                    step: "0.5",
                                    onChange: (e)=>{
                                        updateConfig((config)=>config.modelConfig.presence_penalty = store/* ModalConfigValidator.presence_penalty */.Xm.presence_penalty(e.currentTarget.valueAsNumber));
                                    }
                                })
                            })
                        ]
